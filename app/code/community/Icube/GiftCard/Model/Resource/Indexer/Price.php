 ...
 */
class Icube_GiftCard_Model_Resource_Indexer_Price extends Mage_Catalog_Model_Resource_Product_Indexer_Price_Default
{
    /**
     ...
     * @return Icube_GiftCard_Model_Resource_Indexer_Price
     */
...
//        $openAmounMax    = $this->_addAttributeToSelect($select, 'open_amount_max', 'e.entity_id', 'cs.store_id');
        ...
        $select->joinLeft(
            array('gca' => $this->getTable('icube_giftcard/amount')),

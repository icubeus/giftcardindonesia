...
$connection = $installer->getConnection()->dropForeignKey(
    $installer->getTable('icube_giftcard/amount'),
 ...
 */
$tables = array(
    $installer->getTable('icube_giftcard/amount') => array(
        'columns' => array(
            'value_id' => array(
...
$connection = $installer->getConnection()->addIndex(
    $installer->getTable('icube_giftcard/amount'),
    $installer->getIdxName('icube_giftcard/amount', array('entity_id')),
    array('entity_id')
);

$connection = $installer->getConnection()->addIndex(
    $installer->getTable('icube_giftcard/amount'),
    $installer->getIdxName('icube_giftcard/amount', array('website_id')),
    array('website_id')
);

$connection = $installer->getConnection()->addIndex(
    $installer->getTable('icube_giftcard/amount'),
    $installer->getIdxName('icube_giftcard/amount', array('attribute_id')),
    array('attribute_id')
);

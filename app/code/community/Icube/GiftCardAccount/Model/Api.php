 ...
 */
class Icube_GiftCardAccount_Model_Api extends Mage_Api_Model_Resource_Abstract
{
    /**
    ...
    {
        /** @var $collection Icube_GiftCardAccount_Model_Resource_Giftcardaccount_Collection */
    ...
    public function info($giftcardAccountId)
    {
        ...
        /** @var $historyCollection Icube_GiftCardAccount_Model_Resource_History_Collection */
        $historyCollection = Mage::getModel('icube_giftcardaccount/history')
            ->getCollection()
    ...
    {
        /** @var $giftcardAccount Icube_GiftCardAccount_Model_Giftcardaccount */
        $giftcardAccount = Mage::getModel('icube_giftcardaccount/giftcardaccount')->load($giftcardAccountId);
     ...
     *
     * @param Icube_GiftCardAccount_Model_Giftcardaccount
     * @return array
     */

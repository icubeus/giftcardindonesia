<?php
$installer = $this;
/* @var $installer Icube_CustomerBalance_Model_Resource_Setup */
$installer->startSetup();

/**
 * Create table 'icube_customerbalance/balance'
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('icube_customerbalance/balance'))
    ...
    ->addIndex($installer->getIdxName('icube_customerbalance/balance', array('customer_id', 'website_id'), Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE),
        array('customer_id', 'website_id'), array('type' => Varien_Db_Adapter_Interface::INDEX_TYPE_UNIQUE))
    ->addIndex($installer->getIdxName('icube_customerbalance/balance', array('website_id')),
        array('website_id'))
    ->addForeignKey($installer->getFkName('icube_customerbalance/balance', 'website_id', 'core/website', 'website_id'),
        'website_id', $installer->getTable('core/website'), 'website_id',
        Varien_Db_Ddl_Table::ACTION_SET_NULL, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->addForeignKey($installer->getFkName('icube_customerbalance/balance', 'customer_id', 'customer/entity', 'entity_id'),
        'customer_id', $installer->getTable('customer/entity'), 'entity_id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('Icube Customerbalance');
$installer->getConnection()->createTable($table);

/**
 * Create table 'icube_customerbalance/balance_history'
 */
$table = $installer->getConnection()
    ->newTable($installer->getTable('icube_customerbalance/balance_history'))
    ...
    ->addIndex($installer->getIdxName('icube_customerbalance/balance_history', array('balance_id')),
        array('balance_id'))
    ->addForeignKey($installer->getFkName('icube_customerbalance/balance_history', 'balance_id', 'icube_customerbalance/balance', 'balance_id'),
        'balance_id', $installer->getTable('icube_customerbalance/balance'), 'balance_id',
        Varien_Db_Ddl_Table::ACTION_CASCADE, Varien_Db_Ddl_Table::ACTION_CASCADE)
    ->setComment('Icube Customerbalance History');
$installer->getConnection()->createTable($table);

...
$installer->getConnection()->dropForeignKey(
    $installer->getTable('icube_customerbalance/balance'),
...
$installer->getConnection()->dropForeignKey(
    $installer->getTable('icube_customerbalance/balance_history'),
 ...
 */
$tables = array(
    $installer->getTable('icube_customerbalance/balance') => array(
        'columns' => array(
            'balance_id' => array(
        ...
        'comment' => 'Icube Customerbalance'
    ),
    $installer->getTable('icube_customerbalance/balance_history') => array(
        'columns' => array(
            'history_id' => array(
                'type'      => Varien_Db_Ddl_Table::TYPE_INTEGER,
                'identity'  => true,
        ...
        'comment' => 'Icube Customerbalance History'
    ),
...
$installer->getConnection()->addIndex(
    $installer->getTable('icube_customerbalance/balance'),
    $installer->getIdxName('icube_customerbalance/balance', array('website_id')),
    array('website_id')
);

$installer->getConnection()->addIndex(
    $installer->getTable('icube_customerbalance/balance_history'),
    $installer->getIdxName('icube_customerbalance/balance_history', array('balance_id')),
    array('balance_id')
);
...
$installer->getConnection()->addForeignKey(
    $installer->getFkName(
        'icube_customerbalance/balance_history',
        'balance_id',
        'icube_customerbalance/balance',
        'balance_id'
    ),
